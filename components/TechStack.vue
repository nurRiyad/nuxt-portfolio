  ...
  <div>
    ...
    <div class="overflow-hidden border dark:border-gray-700 shadow rounded-xl">
      <div class="ease-out transition-transform px-5 py-3">
        <div class="flex flex-wrap pb-4 gap-2 justify-start items-baseline ">
          <div class="border border-gray-600 p-2 bg-gray-700 rounded-md">
          ...
          <div class="border border-gray-600 p-2 bg-gray-700 rounded-md">
            <Icon name="logos:nodejs-icon" class="hover:scale-[1.1] ease-out transition-transform" size="35" />
          </div>
          <div class="border border-gray-600 p-2 bg-gray-700 rounded-md">
            <Icon name="simple-icons:express" color="white" class="hover:scale-[1.1] ease-out transition-transform" size="35" />
          </div>
          <div class="border border-gray-600 p-2 bg-gray-700 rounded-md">
          ...
          <div class="border border-gray-600 p-2 bg-gray-700 rounded-md">
            <Icon name="simple-icons:macos" color="white" class="hover:scale-[1.1] ease-out transition-transform" size="35" />
          </div>
          <div class="border border-gray-600 p-2 bg-gray-700 rounded-md">
